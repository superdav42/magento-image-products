...
/**
 * Copy of Magento\Downloadable\Model\ResourceModel\Indexer\Price
 * With fillFinalPrice modified to use productType \DevStone\ImageProducts\Model\Product\Type::TYPE_ID
 */
namespace DevStone\ImageProducts\Model\ResourceModel\Indexer;
...
class Price implements DimensionalIndexerInterface
{
    ...
    private function fillFinalPrice(
        ...
        $select = $this->baseFinalPrice->getQuery($dimensions, Type::TYPE_ID, iterator_to_array($entityIds));
