 ...
 */
class ScripturesForm extends AbstractModifier
{
    ...
    public function modifyData(array $data)
    {
		foreach($data as &$productData) {
			if(isset($productData['product']['scriptures']))  {
				$productData['product']['scriptures'] = explode(',', $productData['product']['scriptures']);
			}
		}
    ...
    {
        $fieldCode = 'scriptures'; //your custom attribute code
...
//                                    ],
    ...
    protected function getOptions()
    {
		...
		$attribute = $this->attributeRepository->get('scriptures');
		$optionIds = explode(',', $product->getScriptures());
